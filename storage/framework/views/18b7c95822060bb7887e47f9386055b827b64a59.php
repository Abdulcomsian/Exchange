                    ...
                    <div class="review-div mt-5">
                        <div class="multiple-client">
                            <div class="client-div text-center">
                                <div class="img-div">
                                    <img src="<?php echo e(asset('FrontEnd/img/user1.jpeg')); ?>" alt="" class="img-fluid m-auto">
                                </div>
                            ...
                            <div class="client-div text-center">
                                <div class="img-div">
                                    <img src="<?php echo e(asset('FrontEnd/img/user2.jpeg')); ?>" alt="" class="img-fluid m-auto">
                                </div>
                                <div class="client-content">
                                    <h4>Ryan G.</h4>
                                    <span>Bought WearWood</span>
                            ...
                            <div class="client-div text-center">
                                <div class="img-div">
                                    <img src="<?php echo e(asset('FrontEnd/img/user3.jpeg')); ?>" alt="" class="img-fluid m-auto">
                                </div>
                                <div class="client-content">
                                    <h4>Ryan G.</h4>
                                    <span>Bought WearWood</span>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.frontEnd.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\Exchange\resources\views/FrontEnd/individual-category.blade.php ENDPATH**/ ?>